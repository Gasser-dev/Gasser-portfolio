...
<form onSubmit={sendEmail} className='flex flex-col w-full bg-black/10 backdrop-blur-md rounded-xl p-6 shadow-lg gap-4'>
  ...
  <div className='flex flex-col gap-2'>
    ...
    <input type="email" placeholder='Enter your Email' name='email_from' className={style.input} required />
  </div>

  <div className='flex flex-col gap-2'>
    <label className={style.label}>Inbox:</label>
    <textarea className={style.input} name='message' placeholder='Message' rows="4" required></textarea>
  </div>
